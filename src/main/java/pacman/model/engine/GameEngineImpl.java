...
//    }
    ...
    private RenderableFactoryRegistry getRenderableFactoryRegistry() {
        ...
        // Register wall factories
        renderableFactoryRegistry.registerFactory(RenderableType.HORIZONTAL_WALL,
                new WallFactory(RenderableType.HORIZONTAL_WALL));
        renderableFactoryRegistry.registerFactory(RenderableType.VERTICAL_WALL,
                new WallFactory(RenderableType.VERTICAL_WALL));
        renderableFactoryRegistry.registerFactory(RenderableType.UP_LEFT_WALL,
                new WallFactory(RenderableType.UP_LEFT_WALL));
        renderableFactoryRegistry.registerFactory(RenderableType.UP_RIGHT_WALL,
                new WallFactory(RenderableType.UP_RIGHT_WALL));
        renderableFactoryRegistry.registerFactory(RenderableType.DOWN_LEFT_WALL,
                new WallFactory(RenderableType.DOWN_LEFT_WALL));
        renderableFactoryRegistry.registerFactory(RenderableType.DOWN_RIGHT_WALL,
                new WallFactory(RenderableType.DOWN_RIGHT_WALL));
        ...
        // Register Pacman factory
        renderableFactoryRegistry.registerFactory(RenderableType.PACMAN, new PacmanFactory());

        // Register ghost factory for each ghost type
        GhostFactory ghostFactory = new GhostFactory();
        renderableFactoryRegistry.registerFactory(RenderableType.BLINKY, ghostFactory);  // 'b'
        renderableFactoryRegistry.registerFactory(RenderableType.PINKY, ghostFactory);   // 's'
        renderableFactoryRegistry.registerFactory(RenderableType.INKY, ghostFactory);    // 'i'
        renderableFactoryRegistry.registerFactory(RenderableType.CLYDE, ghostFactory);   // 'c'
